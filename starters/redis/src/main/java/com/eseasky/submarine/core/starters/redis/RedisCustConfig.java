package com.eseasky.submarine.core.starters.redis;

import com.eseasky.submarine.core.starters.redis.entity.RedisConfigProperties;
import com.eseasky.submarine.core.starters.redis.lock.RLockHandler;
...
@EnableRedisHttpSession(
        redisNamespace = "${spring.redis.session-key-prefix:spring}"
)
